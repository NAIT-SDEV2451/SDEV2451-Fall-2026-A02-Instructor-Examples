// let's install the queryClient and provider.
...
// a common pattern we're going to initialize our queryClient
const queryClient = new QueryClient()

function App() {
  // the queryClientProvider wraps our entire application.
  return (
